...
- **DB messages / session_steps** = events 的物化投影（X12）；抽取与 UI review 读投影；Additional context 不与首条 user 重复
...
**计数**：待办 **0** · 可选 **7**（X 史诗/产品）· 不推荐 **6** · 完成归档本轮 **14**（M1–M6、R1–R6、X7、X12）· 史诗计入可选。
